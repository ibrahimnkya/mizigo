            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Gap(24),
                  ElevatedButton(
                    onPressed: () => context.go('/parcel/send'),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Disclaimer: The estimated cost shown above may vary depending on the actual parcel weight/size, live traffic conditions, tolls, and other variables at the time of delivery.',
                      style: GoogleFonts.inter(
                        fontSize: 12,
                        height: 1.5,
                        color: isDark ? Colors.white54 : const Color(0xFF64748B),
