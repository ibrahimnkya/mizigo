              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    _helpRow(Icons.attach_money, 'Declared Value', 'Enter the market value of the parcel. This is used for insurance reference only.'),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Gap(16),
                Text(
                  'Parcel Details', // Renamed from Package Details or Parcel Details
                  style: GoogleFonts.outfit(
                    fontSize: 22,
                    fontWeight: FontWeight.w700,
                    color: Colors.white,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Parcel Name', // Renamed from Package Name
                    style: GoogleFonts.outfit(
                      fontSize: 18,
                      fontWeight: FontWeight.w600,
                      color: isDark ? Colors.white : const Color(0xFF1E293B),
                  ...
                  const Gap(16),
                  Text(
                    'Parcel Type', // Renamed from Parcel Type
                    style: GoogleFonts.inter(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: isDark ? Colors.white70 : const Color(0xFF475569),
                  ...
                  _buildSelectionTile(
                    'Select Parcel Type',
                    _parcelType,
                    () => _showSelectionSheet(context, 'Parcel Type', parcelTypes, _parcelType, (v) => setState(() => _parcelType = v), isDark),
                    isDark,
                  ),
                  ...
                  const Gap(24),
                  Text(
                    'Parcel Description (Optional)', // Renamed from Parcel Description
                    style: GoogleFonts.outfit(
                      fontSize: 18,
                      fontWeight: FontWeight.w600,
                      color: isDark ? Colors.white : const Color(0xFF1E293B),
