    ...
    <div className="flex flex-col gap-10 p-6 md:p-10 bg-white max-w-[1440px] mx-auto min-h-[85vh] shadow-[0_0_80px_-20px_rgba(0,0,0,0.08)] rounded-[10px] my-8 border border-slate-100/50 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 relative z-10">
        <div>
          ...
          <p className="text-[15px] text-slate-500 font-bold tracking-tight">
            Logistic telemetry for{" "}
            <span className="text-blue-600">{station.name}</span>
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={stat.label}
                className="bg-white rounded-[10px] border border-slate-100 p-6 shadow-sm hover:shadow-xl hover:shadow-slate-100 transition-all group border-slate-100/50"
              >
                <div
                  className={cn(
          ...
          {/* Operational Visuals */}
          <div className="bg-white rounded-[10px] border border-slate-100 p-10 shadow-sm relative overflow-hidden group">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-[18px] font-black text-slate-900 flex items-center gap-3">
                <BarChart3 size={18} className="text-blue-600" />
                Workload Throughput
              </h2>
              <div className="flex items-center gap-2 px-4 py-1.5 rounded-[10px] bg-blue-50 text-blue-600 border border-blue-100 font-black text-[10px] uppercase tracking-widest">
                Global Benchmark
              </div>
            </div>
            <div className="aspect-[21/9] rounded-[10px] bg-slate-50 border border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 gap-3 group-hover:bg-blue-50/30 transition-colors">
        ...
        <div className="space-y-10">
          <div className="bg-slate-900 rounded-[10px] p-10 text-white relative overflow-hidden shadow-2xl shadow-slate-200 border border-slate-800">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-black mb-8 leading-tight">
              ...
              <div className="space-y-6">
                ...
                <div className="h-2 bg-white/10 rounded-[10px] overflow-hidden">
                  <div className="h-full bg-blue-600 w-[95%] rounded-[10px]" />
                </div>
                <p className="text-[12px] text-slate-400 leading-relaxed font-bold pt-4">
                  Operational efficiency is currently rated as{" "}
                  <span className="text-white">highly stable</span> with zero
                  unresolved exceptions logged in the last 24 hours.
                </p>
              </div>
            </div>
          </div>

          <div className="bg-white rounded-[10px] border border-slate-100 p-8 shadow-sm">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.label} className="space-y-2">
                  ...
                  <div className="h-1.5 bg-slate-50 rounded-[10px] overflow-hidden">
                    <div
                      className={cn("h-full rounded-[10px]", item.color)}
