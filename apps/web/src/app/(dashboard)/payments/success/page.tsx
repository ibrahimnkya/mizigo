        ...
        <div className="min-h-screen bg-[#f8f9fb]">
            <div className="max-w-[1520px] mx-auto px-6 lg:px-10 py-10 flex flex-col gap-8">
                <div>
                    ...
                    <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Successful Transactions</h1>
                    <p className="text-sm text-slate-400 font-medium mt-0.5">History of all successfully processed payments.</p>
                </div>
