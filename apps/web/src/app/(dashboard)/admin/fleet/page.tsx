...
function FleetPageInner() {
  ...
  const capacityIndex = "92%"; // Scoped performance metric placeholder
  ...
  const columns = [
    {
      ...
      accessor: (v: any) => (
        <div className="flex items-center gap-4 cursor-pointer group animate-in fade-in">
          <div
            className={cn(
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2 pl-1">
            ...
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
              {v.organization?.name || "My Organization"}
            </span>
          </div>
        </div>
      ),
    ...
    <div className="min-h-screen bg-[#f8f9fb] p-6 lg:p-10">
      <div className="max-w-[1520px] mx-auto flex flex-col gap-6">
        <ReportPageHeader
          ...
          subtitle="Monitor and manage your organization's locomotives and transport assets"
          iconName="TrainFront"
