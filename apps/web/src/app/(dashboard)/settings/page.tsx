    ...
    items: [
      {
        ...
        desc: "Receive updates via your registered email",
        defaultChecked: true,
      },
      {
        id: "push-notifications",
        label: "Push Notifications",
        desc: "Desktop alerts for instant system events",
    ...
    items: [
      {
        id: "dark-mode",
        label: "Dark Mode",
        desc: "Switch to a darker, low-light theme",
        defaultChecked: false,
      },
      {
        id: "compact-mode",
        label: "Compact Mode",
        desc: "Denser layout with reduced padding",
        defaultChecked: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "Make your profile visible to other terminals",
        defaultChecked: false,
      },
    ],
  },
      ...
      <div className="max-w-[1520px] mx-auto px-6 lg:px-10 py-10 flex flex-col gap-8">
        <div>
          ...
          <p className="text-sm text-slate-400 font-medium mt-0.5">
            Manage your account preferences, security, and interface
            configuration.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {settingsSections.map((section) => (
            <div
              key={section.title}
              className="bg-white rounded-[10px] border border-slate-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden"
            >
                ...
                {section.items.map((item) => (
                  ...
                  >
                    <div>
                      <Label
                        htmlFor={item.id}
                        className="text-[13px] font-bold text-slate-800 cursor-pointer leading-none"
                      >
                        {item.label}
                      </Label>
        ...
        <div className="bg-white rounded-[10px] border border-slate-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
          ...
          <div className="px-5 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-[10px] bg-blue-50 flex items-center justify-center text-[13px] font-extrabold text-blue-600">
                DB
              </div>
              <div>
            ...
            <form action={logout}>
              <button
                type="submit"
                className="inline-flex items-center gap-1.5 text-[11px] font-extrabold uppercase tracking-widest text-rose-500 hover:text-rose-600 transition-colors"
              >
