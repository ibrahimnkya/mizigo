  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-5 relative z-10">
        <div
          className={`w-11 h-11 flex items-center justify-center rounded-[10px] ${iconBg} shadow-lg shadow-black/5 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}
        >
        ...
        {trend && (
          <span
            className={`inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-1 rounded-full backdrop-blur-md shadow-sm border ${
              trend.up
      ...
      <div className="relative z-10">
        ...
        {sub && (
          <p className="text-[12px] text-slate-500 font-semibold mt-2 opacity-70">
            {sub}
          </p>
        )}
      </div>
...
export function MetricCard({
  ...
  return (
    <div className="relative group bg-white rounded-[10px] border border-slate-100 p-5 flex flex-col gap-4 shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-200">
...
export function Card({
  ...
  return (
    <div
      className={cn(
        "bg-white rounded-[10px] border border-slate-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)]",
        className,
      )}
    >
      {children}
...
export function Panel({
  ...
  const iconHex = iconColor.includes("indigo")
    ? "#6366f1"
