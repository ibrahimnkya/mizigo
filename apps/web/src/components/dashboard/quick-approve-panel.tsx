    ...
    <Card className="border-none shadow-md bg-white overflow-hidden">
      ...
      <div className="p-3 bg-slate-50/50 border-t border-slate-50 text-center">
        <Button
          variant="ghost"
          size="sm"
          className="text-indigo-600 hover:text-indigo-700 hover:bg-transparent font-medium"
          asChild
        >
          <Link href="/parcel">View all parcel entries</Link>
        </Button>
      </div>
    </Card>
  );
