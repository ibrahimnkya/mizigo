 ...
 * Used by /api/parcel/[id]/receipt/pdf to generate a downloadable PDF.
 *
...
export function createReceiptPDF(data: ReceiptData) {
  ...
  return (
    <Document
      ...
      subject="Parcel Payment Receipt"
      keywords="receipt, parcel, mizigo, logistics"
    >
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          {/* Route */}
          <View style={s.section}>
            <Text style={s.sectionTitle}>Parcel & Route</Text>
            {[
              ["Parcel Ref.", `#${data.parcelRef}`],
              ["From", route.from],
              ["To", route.to],
