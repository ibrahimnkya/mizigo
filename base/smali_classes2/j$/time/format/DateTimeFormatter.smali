...
.method public final a(Ljava/lang/CharSequence;)Lj$/time/format/w;
    ...
    .line 169
    iget-object v1, v4, Lj$/time/format/p;->a:Lj$/time/format/DateTimeFormatter;
    ...
    .line 329
    :cond_2
    iput-object v1, v8, Lj$/time/format/w;->c:Lj$/time/chrono/l;

    .line 330
    iget-object v1, v8, Lj$/time/format/w;->b:Lj$/time/ZoneId;
    ...
    .line 330
    :goto_1
    iput-object v6, v8, Lj$/time/format/w;->b:Lj$/time/ZoneId;

    .line 252
    iget-object v1, v0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/format/x;

    iput-object v1, v8, Lj$/time/format/w;->e:Lj$/time/format/x;

    .line 265
    invoke-virtual {v8}, Lj$/time/format/w;->q()V

    .line 360
    iget-object v1, v8, Lj$/time/format/w;->c:Lj$/time/chrono/l;

    iget-object v2, v8, Lj$/time/format/w;->a:Ljava/util/Map;

    iget-object v4, v8, Lj$/time/format/w;->e:Lj$/time/format/x;

    invoke-interface {v1, v2, v4}, Lj$/time/chrono/l;->S(Ljava/util/Map;Lj$/time/format/x;)Lj$/time/chrono/b;

    move-result-object v1

    invoke-virtual {v8, v1}, Lj$/time/format/w;->y(Lj$/time/chrono/b;)V

    .line 267
    invoke-virtual {v8}, Lj$/time/format/w;->u()V

    .line 271
    iget-object v1, v8, Lj$/time/format/w;->a:Ljava/util/Map;
    ...
    .line 277
    iget-object v5, v8, Lj$/time/format/w;->a:Ljava/util/Map;

    iget-object v6, v8, Lj$/time/format/w;->e:Lj$/time/format/x;

    invoke-interface {v4, v5, v8, v6}, Lj$/time/temporal/q;->F(Ljava/util/Map;Lj$/time/format/w;Lj$/time/format/x;)Lj$/time/temporal/TemporalAccessor;
    ...
    iput-object v1, v8, Lj$/time/format/w;->b:Lj$/time/ZoneId;
    ...
    iget-object v2, v8, Lj$/time/format/w;->b:Lj$/time/ZoneId;
    ...
    invoke-virtual {v8, v1, v2}, Lj$/time/format/w;->v(Lj$/time/l;Lj$/time/s;)V
    ...
    invoke-virtual {v8, v5}, Lj$/time/format/w;->y(Lj$/time/chrono/b;)V
    ...
    invoke-virtual {v8, v5, v1}, Lj$/time/format/w;->v(Lj$/time/l;Lj$/time/s;)V
    ...
    iget-object v3, v8, Lj$/time/format/w;->e:Lj$/time/format/x;
    ...
    :cond_e
    :goto_6
    iget-object v1, v8, Lj$/time/format/w;->g:Lj$/time/l;
    ...
    invoke-virtual {v8, v9, v12, v1}, Lj$/time/format/w;->z(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 512
    iget-object v10, v8, Lj$/time/format/w;->a:Ljava/util/Map;
    ...
    .line 513
    iget-object v12, v8, Lj$/time/format/w;->a:Ljava/util/Map;
    ...
    .line 514
    iget-object v14, v8, Lj$/time/format/w;->a:Ljava/util/Map;
    ...
    invoke-virtual/range {v8 .. v16}, Lj$/time/format/w;->s(JJJJ)V
    ...
    .line 535
    :goto_d
    iget-object v1, v8, Lj$/time/format/w;->e:Lj$/time/format/x;
    ...
    invoke-virtual {v4}, Lj$/time/temporal/a;->Y()Z
    ...
    invoke-virtual {v3, v4, v5}, Lj$/time/temporal/a;->X(J)V
    ...
    :cond_1a
    :goto_f
    iget-object v1, v8, Lj$/time/format/w;->f:Lj$/time/chrono/b;

    if-eqz v1, :cond_1b

    .line 634
    invoke-virtual {v8, v1}, Lj$/time/format/w;->p(Lj$/time/temporal/TemporalAccessor;)V
    ...
    iget-object v2, v8, Lj$/time/format/w;->g:Lj$/time/l;
    ...
    iget-object v1, v8, Lj$/time/format/w;->h:Lj$/time/s;
    ...
    iget-object v3, v8, Lj$/time/format/w;->h:Lj$/time/s;

    invoke-interface {v1, v3}, Lj$/time/chrono/b;->R(Lj$/time/temporal/p;)Lj$/time/chrono/b;

    move-result-object v1

    iput-object v1, v8, Lj$/time/format/w;->f:Lj$/time/chrono/b;

    .line 572
    iput-object v2, v8, Lj$/time/format/w;->h:Lj$/time/s;
    ...
    .line 585
    iget-object v3, v8, Lj$/time/format/w;->a:Ljava/util/Map;
    ...
    .line 602
    iget-object v2, v8, Lj$/time/format/w;->f:Lj$/time/chrono/b;

    iget-object v3, v8, Lj$/time/format/w;->g:Lj$/time/l;
